...
<div class="container" id="meetings">
    <div class="tab-pane fade show active p-3" id="home">
        ...
        <form method="POST" action="{{ route('book-meeting-post') }}">
            ...
            <div class="form-group">
                <label for="description">Opis <br /> <span class="small">Proszę podać gatunek, rasę, wiek zwierzęcia oraz w skrócie opisać czego będzie dotyczyła wizyta.</span></label>
                <textarea id="description" name="description" class="form-control rounded-0" rows="4" maxlength="2000"></textarea>
                @error('description')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <button type="submit" class="mt-4 btn btn-primary centerButton">Zatwierdź</button>
        </form>
    </div>
</div>
@endsection