            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link clr-white" href="#services">NASZE USŁUGI<span
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="mt-4">
                            ...
                            <button class="btn btn-primary"><a class=" clr-white"
                                    href="{{ route('book-meeting-get') }}">UMÓW SIĘ</a></button>
                        </div>
                    </div>
                    <img class="col img-head" src="{{ asset('svgs/veterinarian-check-ing-puppy-s-health.png') }}"
                        alt="">
                </div>
            </div>
        </section>
        ...
        <section class="opinion mt-4 p-2">
            ...
            <div id="myCarousel" class="carousel slide mt-4" data-ride="carousel">
                <ol class="carousel-indicators">
                    <li data-target="#myCarousel" data-slide-to="0" class="active bg-blue"></li>
                    <li data-target="#myCarousel" data-slide-to="1" class="bg-blue"></li>
                    <li data-target="#myCarousel" data-slide-to="2" class="bg-blue"></li>
                </ol>
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="container">
                            <div class="carousel-caption text-center clr-gray ">
                                <p class="opi">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula
