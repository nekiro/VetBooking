    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class=" login_input input-group">
            ...
            <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror"
                name="firstname" value="{{ old('firstname') }}" placeholder="Imie" autocomplete="name" autofocus>
        </div>
        ...
        <div class=" login_input input-group">
            ...
            <input id="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror"
                name="lastname" value="{{ old('lastname') }}" placeholder="Nazwisko" autocomplete="lastname" autofocus>
        </div>
        ...
        <div class=" login_input input-group">
            ...
            <input id="phone_number" type="text" class="form-control @error('phone_number') is-invalid @enderror"
                name="phone_number" value="{{ old('phone_number') }}" placeholder="Numer telefonu"
        ...
        <div class=" login_input input-group">
            <div class="input-group-prepend">
                <div class="input-group-text" style="background: transparent">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#00a3e8">
                        <path
        ...
        <div class=" login_input input-group">
            ...
            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror"
                placeholder="Hasło" name="password" autocomplete="new-password">
        </div>
